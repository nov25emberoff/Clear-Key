...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout.addView(TextView(this).apply {
            text = "FCC Keyboard"; textSize = 28f; setTextColor(0xFFFFFFFF.toInt())
        })

        layout.addView(TextView(this).apply {
            text = "Chat Control? Fuck it."; textSize = 14f
        ...
        layout.addView(Button(this).apply {
            text = "ENABLE FCC KEYBOARD"; textSize = 15f
            ...
            setOnClickListener {
                if (PanicService.isPanicActive) {
                    ...
                    if (isAccessibilityServiceEnabled()) {
                        ...
                        Toast.makeText(this@SettingsActivity, "Enable FCC in Accessibility settings first", Toast.LENGTH_LONG).show()
        ...
        layout.addView(TextView(this).apply {
            text = "FCC Keyboard © 2026\nFuck Chat Control — Messages appear innocent to any scanner"
